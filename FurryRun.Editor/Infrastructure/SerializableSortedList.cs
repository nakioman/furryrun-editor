...
namespace FurryRun.Editor.Infrastructure
{
    ...
    ///     the associated System.Collections.Generic.IComparer<T> implementation.</T>
    /// </summary>
    ...
    public class SerializableSortedList<TKey, TValue> : SortedList<TKey, TValue>, IXmlSerializable
    {
        ...
        private readonly Type _mTKey = typeof(TKey);
        private readonly Type _mTValue = typeof(TValue);
        ...
        void IXmlSerializable.ReadXml(XmlReader reader)
        {
            ...
            var keySerializer = new XmlSerializer(_mTKey);
            var valueSerializer = new XmlSerializer(_mTValue);

            // Get key-value pair name
            string keyValuePairName = SerializableGenerics.GetKeyValuePairName(_mTKey, _mTValue);
